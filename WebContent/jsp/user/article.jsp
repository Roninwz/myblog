  ...
  <div class="content-wrap">
    ...
    <s:iterator value="#articles" status="articles" var="ar">
      <header class="article-header">
        <h1 class="article-title"><a href="article.html"><s:property value="title"></s:property></a></h1>
        <div class="article-meta"> <span class="item article-meta-time">
          <time class="time" data-toggle="tooltip" data-placement="bottom" title="时间：2016-1-4 10:29:39"><i class="glyphicon glyphicon-time"></i><s:property value="date"></s:property></time>
      ...
      <article class="article-content">
        <div>
        <s:property value="#ar.content.content"></s:property>
        </div>	
      
    <%--   <textarea rows="" cols="" disabled="disabled"><s:property value="#ar.content.content"></s:property> --%>
      </textarea>
      </article>
     ...
     <div class="article-tags">标签：<a href="" rel="tag">PHP</a></div>
      ...
      <div id="respond">
        <form action="" method="post" id="comment-form">
          <div class="comment">
            <div class="comment-title"><img class="avatar" src="static/user/images/icon/icon.png" alt="" /></div>
            <div class="comment-box">
              <textarea placeholder="您的评论可以一针见血" name="comment" id="comment-textarea" cols="100%" rows="3" tabindex="1" ></textarea>
              <div class="comment-ctrl"> <span class="emotion"><img src="static/user/images/face/5.png" width="20" height="20" alt="" />表情</span>
      ...
      <div id="postcomments">
        <ol class="commentlist">
          <li class="comment-content"><span class="comment-f">#1</span>
            <div class="comment-avatar"><img class="avatar" src="static/user/images/icon/icon.png" alt="" /></div>
      ...
      <div class="widget widget-tabs">
        ...
        <div class="tab-content">
          <div role="tabpanel" class="tab-pane notice active" id="notice">
            <ul>
              <li>
                ...
                <a href="" target="_blank">欢迎访问朕的博客</a></li>
              <li>
                <time datetime="2016-01-04">01-04</time>
          ...
          <div role="tabpanel" class="tab-pane contact" id="contact">
            <h2>Email:<br />
              <a href="mailto:admin@ylsat.com" data-toggle="tooltip" data-placement="bottom" title="admin@ylsat.com">1947914887@qq.com</a></h2>
          </div>
        </div>
      </div>
...
<script src="static/user/js/jquery.qqFace.js"></script> 
<script type="text/javascript">
$(function(){
	$('.emotion').qqFace({
		id : 'facebox', 
		assign:'comment-textarea', 
		path:'static/user/images/arclist/'	//表情存放的路径
	});
 });   
</script>
</body>
