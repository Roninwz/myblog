...
<section class="container">
  <div class="content-wrap">
    <div class="content">
      ...
      <article class="excerpt excerpt-1"><a class="focus" href="selectArticle?id=<s:property value="#ar.content.id"></s:property>" title=""><img class="thumb" data-original='<s:property value="imgurl"></s:property>' src='<s:property value="imgurl"></s:property>' alt=""></a>
        <header><a class="cat" href="program"><s:property value="keywords"></s:property><i></i></a>
