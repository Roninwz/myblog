            ...
            <tbody>
             <s:iterator value="#articles" status="articles" var="ar">
              <tr>
                ...
                <td class="article-title"><s:property value="title"></s:property></td>
                <td> <s:property value="#ar.category.chiName"></s:property></td>
                <td class="hidden-sm"><s:property value="keywords"></s:property></td>
                <td class="hidden-sm">0</td>
                <td><s:property value="createDate"></s:property></td>
                <td><a href="updateA?id=<s:property value="id"></s:property>">修改</a> <a rel="6" href="deleteArticle?id=<s:property value="id"></s:property>">删除</a></td>
              </tr>
               </s:iterator>
